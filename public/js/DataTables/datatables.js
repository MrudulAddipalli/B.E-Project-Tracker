 ...
 *   https://datatables.net/download/#dt/dt-1.10.12,fh-3.1.2,r-2.1.0,se-1.2.0
 *
 * Included libraries:
...
(function( $, window, document, undefined ) {
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var div = $('<div><label style=\'font-weight:100\'/></div>').addClass( classes.sLength );
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.12,fh-3.1.2,r-2.1.0,se-1.2.0",
...
Responsive.breakpoints = [
	{ name: 'largescreen',  width: Infinity },
