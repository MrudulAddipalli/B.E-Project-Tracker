        ...
        createDropdown: function() {
            ...
            var drop =
                "<div class='btn-group bootstrap-select" + multiple + "'>" +
                    "<button type='button' class='grey_placeholder btn dropdown-toggle remove-shadow btn-lg selectpicker ' data-toggle='dropdown'>" +
                        "<div class='filter-option pull-left'></div>&nbsp;" +
                        "<div class='caret'></div>" +
                    "</button>" +
                    "<div class='dropdown-menu open' style='margin-left:-15px;'>" +
                        header +
                        searchbox +
