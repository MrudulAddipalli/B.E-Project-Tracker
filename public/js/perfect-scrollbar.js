...
jQuery(document).ready(function ($) {
	// "use strict";
	// $('#section-menu-scroll').perfectScrollbar();
	// $('#fav-menu-scroll').perfectScrollbar();
	// //$('#notification-scroll').perfectScrollbar();
	// $('#search-scroll').perfectScrollbar();
  $('#body-scroll').perfectScrollbar();
});
/*==================== On Page Js End ====================*/